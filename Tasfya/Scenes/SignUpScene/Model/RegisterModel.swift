...
struct regData: Codable {
    let customersID, customersGender, customersFirstname: String
    let customersLastname: String
    let email: String
    //  let userName, customersDefaultAddressID: JSONNull?
...
//        case customersTelephone = "customers_telephone"
//      //  case customersFax = "customers_fax"
//        case password = "customers_password"
//    //    case customersNewsletter = "customers_newsletter"
//        case isActive
//    //    case fbID = "fb_id"
//   //     case googleID = "google_id"
...
class RegisterData: Codable, Hashable {

    public static func == (lhs: RegisterData, rhs: RegisterData) -> Bool {
        return true
    }
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if !container.decodeNil() {
            throw DecodingError.typeMismatch(RegisterData.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for JSONNull"))
        }
    }
